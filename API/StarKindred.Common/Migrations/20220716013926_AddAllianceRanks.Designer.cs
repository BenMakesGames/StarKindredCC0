...
{
    [DbContext(typeof(Db))]
    [Migration("20220716013926_AddAllianceRanks")]
    partial class AddAllianceRanks
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StarKindred.Common.Entities.Db.AllianceSeekingMembers", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<int>("InvitesRemaining")
                        .HasColumnType("int");
                    ...
                    b.ToTable("AllianceSeekingMembers");
                });
            ...
            modelBuilder.Entity("StarKindred.Common.Entities.Db.AllianceSeekingMembers", b =>
                {
                    b.HasOne("StarKindred.Common.Entities.Db.Alliance", "Alliance")
                        .WithOne()
                        .HasForeignKey("StarKindred.Common.Entities.Db.AllianceSeekingMembers", "AllianceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("StarKindred.Common.Entities.Db.LevelRange", "LevelRange", b1 =>
                        {
                            b1.Property<Guid>("AllianceSeekingMembersId")
                                .HasColumnType("char(36)");
                            ...
                            b1.HasKey("AllianceSeekingMembersId");

                            b1.ToTable("AllianceSeekingMembers");

                            b1.WithOwner()
                                .HasForeignKey("AllianceSeekingMembersId");
                        });
