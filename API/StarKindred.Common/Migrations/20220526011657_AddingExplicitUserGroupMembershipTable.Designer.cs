...
{
    [DbContext(typeof(Db))]
    [Migration("20220526011657_AddingExplicitUserGroupMembershipTable")]
    partial class AddingExplicitUserGroupMembershipTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StarKindred.Common.Entities.Db.Group", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("StarKindred.Common.Entities.Db.GroupMonster", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("GroupMonsters");
                });

            modelBuilder.Entity("StarKindred.Common.Entities.Db.GroupMonsterContribution", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("GroupMonsterContributions");
                });
            ...
            modelBuilder.Entity("StarKindred.Common.Entities.Db.User", b =>
                {
                    ...
                    b.Property<bool>("IsLookingForGuild")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("StarKindred.Common.Entities.Db.UserGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("StarKindred.Common.Entities.Db.GroupMonster", b =>
                {
                    b.HasOne("StarKindred.Common.Entities.Db.Group", "Group")
                        .WithOne("GroupMonster")
                        .HasForeignKey("StarKindred.Common.Entities.Db.GroupMonster", "GroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("StarKindred.Common.Entities.Db.UserGroup", b =>
                {
                    ...
                    b.HasOne("StarKindred.Common.Entities.Db.User", "User")
                        .WithOne("UserGroup")
                        .HasForeignKey("StarKindred.Common.Entities.Db.UserGroup", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
