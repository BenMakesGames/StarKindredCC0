...
{
    [DbContext(typeof(Db))]
    [Migration("20221104013725_AddingAllianceLastActiveOnDate")]
    partial class AddingAllianceLastActiveOnDate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StarKindred.Common.Entities.Db.AnnouncementView", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("StarKindred.Common.Entities.Db.TownLeader", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("StarKindred.Common.Entities.Db.UserResearch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("StarKindred.Common.Entities.Db.UserSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("StarKindred.Common.Entities.Db.UserTechnology", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("StarKindred.Common.Entities.Db.AnnouncementView", b =>
                {
                    b.HasOne("StarKindred.Common.Entities.Db.User", "User")
                        .WithOne()
                        .HasForeignKey("StarKindred.Common.Entities.Db.AnnouncementView", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("StarKindred.Common.Entities.Db.TownLeader", b =>
                {
                    ...
                    b.HasOne("StarKindred.Common.Entities.Db.Vassal", "Vassal")
                        .WithOne("Leader")
                        .HasForeignKey("StarKindred.Common.Entities.Db.TownLeader", "VassalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
