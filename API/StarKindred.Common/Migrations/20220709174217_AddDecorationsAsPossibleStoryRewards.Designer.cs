...
{
    [DbContext(typeof(Db))]
    [Migration("20220709174217_AddDecorationsAsPossibleStoryRewards")]
    partial class AddDecorationsAsPossibleStoryRewards
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StarKindred.Common.Entities.Db.Vassal", b =>
                {
                    ...
                    b.Property<Guid?>("AdventureStepInProgressId")
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("AdventureStepInProgressId");
            ...
            modelBuilder.Entity("StarKindred.Common.Entities.Db.Vassal", b =>
                {
                    b.HasOne("StarKindred.Common.Entities.Db.AdventureStep", "AdventureStepInProgress")
                        .WithMany()
                        .HasForeignKey("AdventureStepInProgressId");
                    ...
                    b.HasOne("StarKindred.Common.Entities.Db.UserAdventureStepInProgress", null)
                        .WithMany("Vassals")
                    ...
                    b.Navigation("AdventureStepInProgress");
